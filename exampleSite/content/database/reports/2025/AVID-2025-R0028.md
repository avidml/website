---
title: AVID-2025-R0028
layout: page
url: /database/AVID-2025-R0028
---

## Description

Evaluation of the LLM DeepSeek-R1 on the cybermetric_2000 benchmark using Inspect Evals
...
| Scorer | Metric | Value |
| --- | --- | --- |
| choice | accuracy | 0.88 |
| choice | stderr | 0.01 |

## References

- [Inspect Evaluation Log for dataset: CyberMetric-2000](https://avidmvp.s3.amazonaws.com/2025-05-13T12-27-56+00-00_cybermetric-2000_UVJDdndtPUkkJhAAABYmX5.eval)
...
- **Version:** 0.2
- [AVID Entry](https://github.com/avidml/avid-db/tree/main/reports/2025/AVID-2025-R0028.json)
