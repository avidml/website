---
title: AVID-2026-R0458
layout: page
url: /database/AVID-2026-R0458
---

## Description

The model gemma-3n-E4B-it from Google was evaluated by the Garak LLM Vulnerability scanner using the probe `dan.Ablation_Dan_11_0`.
...
| --- | --- | --- | --- |
| dan.DAN | 0 | 127 | 🔴 0.0 |
| mitigation.MitigationBypass | 27 | 127 | 🟠 21.3 |
...
- **Version:** 
- [AVID Entry](https://github.com/avidml/avid-db/tree/main/reports/2026/AVID-2026-R0458.json)
