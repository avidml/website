---
title: AVID-2026-R0198
layout: page
url: /database/AVID-2026-R0198
---

## Description

The model Kimi-K2-Instruct-0905 from Moonshot AI was evaluated by the Garak LLM Vulnerability scanner using the probe `promptinject.HijackHateHumans`.
...
| --- | --- | --- | --- |
| promptinject.AttackRogueString | 98 | 256 | 🟠 38.3 |
...
- **Version:** 
- [AVID Entry](https://github.com/avidml/avid-db/tree/main/reports/2026/AVID-2026-R0198.json)
